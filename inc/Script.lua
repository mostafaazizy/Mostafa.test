...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/MahmoudM5/test.github.io/master/GetVersion.txt' ) or 0
...
return 'ٴ𐄬 اصدار سورس العزايزي : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'↯ 𖠲 عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس العزايزي يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
send_key(msg.sender_user_id_,'   [قناة سورس : العزايزي](https://t.me/al_aziza1)' ,nil,inline,msg.id_)
return false
end
...
[مطور السورس](t.me/Mostafa_Aziza)

[صاحب السورس](t.me/MahmoudM2)
]]
end
...
elseif Text== "ملك التلجرام" or Text== "مطور السورس" then return  sendMsg(msg.chat_id_,msg.id_,"[باسل اباظه ♧](https://t.me/xb_1b)")
...
❆رابط حذف [Snspchat](https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.snapchat.com%2Faccounts%2Fdeleteaccount) ܁
  ...
  --=====================================
  elseif Text== "فارس" or Text== " فارس " or Text=="فارس" then
if msg.SudoUser then  
return sendMsg(msg.chat_id_,msg.id_,"[مطور السورس.](https://t.me/IE_S9) ")
