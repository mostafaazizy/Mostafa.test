--[[
الالعاب ل سورس سيلا
تم تعديل الملف واضافه الالعاب من قبل فارس (@IE_S9)
--]]
...
name = string.gsub(name," دحوو6م ","  هل يعجبك باسل ام كسم حجاج  ؟ ")
...
name = string.gsub(name," دحوو14م "," اي رايك في سورس سيلا ؟ ")
...
name = string.gsub(name," دحوو115م ","  لي فارس حارق كتير  ؟ ")
name = string.gsub(name," دحوو116م "," ردة فعلك لما تنظلم من شخص ؟ ")
name = string.gsub(name," دحوو117م "," شيء تعترف انك فاشل فيه ؟ ")
name = string.gsub(name," دحوو118م "," لي في اخر كل خناقه او كلام كسم حجاج ؟ ")
